...
Contents
data/: Raw and processed datasets used in the study, separated by ais, whales, and studyarea.

scripts/: Scripts used for data processing and analysis. 

outputs/: Output files generated by the code.

figures/: Scripts to make several final figures used in the manuscript and figures produced. 
